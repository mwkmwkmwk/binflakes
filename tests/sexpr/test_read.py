...
class TestRead:
    @pytest.mark.parametrize(('s', 't', 'v'), [
        ...
        ('\'a\'', IntNode, BinInt(0x61)),
        ('\'\u1234\'', IntNode, BinInt(0x1234)),
        ('\'\\n\'', IntNode, BinInt(0x0a)),
        ('\'\\u1234\'', IntNode, BinInt(0x1234)),
        ...
        ('7\'\'a\'', WordNode, BinWord(7, 0x61)),
        ('16\'\'\u1234\'', WordNode, BinWord(16, 0x1234)),
        ('8\'\'\\n\'', WordNode, BinWord(8, 0x0a)),
        ('32\'\'\\u1234\'', WordNode, BinWord(32, 0x1234)),
    ...
    @pytest.mark.parametrize(('s', 'e'), [
        ...
        ('8\'\'ab\'', 'no whitespace'),
        ('8\'\'\\c\'', 'no whitespace'),
        ('\'\\U123456\'', 'not a valid unicode codepoint'),
    ])
